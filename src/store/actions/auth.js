...
// holds the async code doing the authentication
// will help to check also if the email they enter is already in use or not?
    ...
    return dispatch => {
        ...
        axios.post(url, authData)
            .then(response => {
                ...
                // will help us to save sessions Lesson 336
    ...
    return dispatch => {
        ...
        if (!token) {
            ...
            if (expirationDate <= new Date()) {
                ...
                // Lesson 337 had a lot of errors with numbers and logic
